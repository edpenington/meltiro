...
- a short identity label: a summary of the paper, and, for a relationship-level field, a one-line record label carrying the record id and any context fields;
